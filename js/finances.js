...
//	          } else {
	...
	$(document).on('click', '.editFin', function () {
		...
		$('#fin_autorenewal').val(rowdata.AutoRenewal);
		...
		if (rowdata.AutoRenewal == '1') {
			$(".finmodal_caution").hide();
			$(".finmodal_renewal").show();
		} else {
			$(".finmodal_caution").show();
			$(".finmodal_renewal").hide();
		}
